...
public class MembermainController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        String usernameL = User.getName();
        username.setText(usernameL);
    }

    public void goToCurrent(ActionEvent actionEvent) {
        loadWindow("../currentbooks/currentbooks.fxml", "Library Information System - Add Book");
    }

    public void goToSearch(ActionEvent actionEvent) {
        loadWindow("../ownbook/ownbook.fxml", "Library Information System - Search");
    }

    public void goToCatalogue(ActionEvent actionEvent) {
        loadWindow("../catalogue/catalogue.fxml","Library Information System - Catalogue");
    }
