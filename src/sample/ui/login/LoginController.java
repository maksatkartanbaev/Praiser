    ...
    public void tryLogin(ActionEvent event) throws IOException{
        ...
        try{
            while (rs.next()){
                ...
                if (DBusername.toLowerCase().equals(username.getText().toLowerCase()) && DBpassword.equals(password.getText())){
                    ...
                    if(User.getType().equals("member")){
                        ...
                        Parent root = FXMLLoader.load(getClass().getResource("../adminmain/adminmain.fxml"));
                        Scene scene = new Scene(root);
                        Stage appStage = (Stage) ((Node) event.getSource()).getScene().getWindow();
